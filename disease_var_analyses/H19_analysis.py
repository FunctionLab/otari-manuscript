...
def get_H19_variant_effects(gene_id = 'ENSG00000130600'):
    ...
    for variant in variant_list:
        clinvar_df = pd.read_csv('/mnt/home/alitman/ceph/isoModel_w_gnn/variant_effects/clinvar_H19_variant/interpretability_analysis.tsv', sep='\t')
        vep = pd.read_csv('/mnt/home/alitman/ceph/isoModel_w_gnn/variant_effects/clinvar_H19_variant/variant_effects_comprehensive.tsv', sep='\t')
